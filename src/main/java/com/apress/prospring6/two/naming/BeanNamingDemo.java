...
SOFTWARE.
*/
package com.apress.prospring6.two.naming;
...
public class BeanNamingDemo {
    ...
    public static void main(String... args) {
        ...
        try {
            ...
            System.out.println("More beans than expected found. " + e);
        }

        System.out.println(" ... All beans of type: " + SimpleBean.class.getSimpleName());
